 ...
 */
export function getListOfWagons(...theArgs) {
  const ids = [...theArgs]; //this is stupid it doesnt check if they are in an array
  return ids;
}
...
export function correctListOfWagons(ids, missingWagons) {
  let [a,...rest]= ids;
  let allWagons = [a,...missingWagons,...rest]
  return allWagons;
}
...
export function extendRouteInformation(information, additional) {
 let addInfo = {...information,...additional};
  return addInfo;
}
